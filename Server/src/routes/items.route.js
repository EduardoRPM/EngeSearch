...
const { getAllItems, getItemById, createItem, deleteItem, updateItem, searchItems, searchItemsPreview } = require("../controllers/items.controller");
...
router.post("/search/preview", searchItemsPreview);
